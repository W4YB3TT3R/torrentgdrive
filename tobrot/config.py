...
class Config(object):
    ...
    APP_ID = int(os.environ.get("APP_ID", 1319693))
    API_HASH = os.environ.get("API_HASH", "25976035403b1269f2793be2bb48c8ab")
    OWNER_ID = int(os.environ.get("OWNER_ID", 899602727))
